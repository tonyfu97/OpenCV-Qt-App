...
struct qt_meta_stringdata_AffinePlugin_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AffinePlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AffinePlugin_t qt_meta_stringdata_AffinePlugin = {
    {
QT_MOC_LITERAL(0, 0, 12) // "AffinePlugin"
...
static const uint qt_meta_data_AffinePlugin[] = {
...
QT_INIT_METAOBJECT const QMetaObject AffinePlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_AffinePlugin.data,
    qt_meta_data_AffinePlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AffinePlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AffinePlugin.stringdata0))
